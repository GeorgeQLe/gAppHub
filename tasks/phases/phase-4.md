...
- [x] Step 4.3: Add iOS-style page indicator dots
...
### Green
- [x] Step 4.6: Write regression tests covering Phase 4 acceptance criteria
...
- [x] Step 4.7: Run all tests, verify they pass, build succeeds with `npm run build` _(no-op — 55/55 tests pass, build succeeds)_
...
**On Completion:**
- Deviations from plan: search integration tests use mouse drag instead of touch events (jsdom touch support is limited); SearchOverlay dismiss behaviors tested standalone for reliability
